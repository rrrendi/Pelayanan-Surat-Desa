                ...
                <form method="POST" action="{{ route('surat.store') }}" id="formPengajuan">
                    ...
                    <div class="form-section">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control form-control-modern" value="{{ Auth::user()->name }}" readonly>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label-modern">
                                    <i class="bi bi-envelope"></i> Email
                                </label>
                                <input type="text" class="form-control form-control-modern" value="{{ Auth::user()->email }}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control form-control-modern" value="{{ Auth::user()->nik }}" readonly>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label-modern">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control form-control-modern" rows="2" readonly>{{ Auth::user()->alamat }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="surat_jenis_id" class="form-select form-select-modern" required id="jenisSurat">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="keterangan" class="form-control form-control-modern" rows="5" required placeholder="Jelaskan secara detail keperluan surat ini. Contoh: Untuk keperluan pembuatan rekening bank di Bank Mandiri..." id="keterangan">{{ old('keterangan') }}</textarea>
